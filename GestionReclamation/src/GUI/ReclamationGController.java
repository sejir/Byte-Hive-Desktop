...
public class ReclamationGController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        Guide gg = new Guide();
        col_id.setCellValueFactory(new PropertyValueFactory<Guide , Integer>("id"));
    ...
    private void recDetails(MouseEvent event) {
        ...
        if (guide != null) {
            ...
            idguide = guide.getId();
            guideidtext.setText(String.valueOf(idguide));
            
        
         
     }
        guideidtext.setVisible(true);
